...
namespace Pyran.NeuroFTK.Utils
{
    public static class StringMessages
    {
        ...
        public const string MarketQuery = $"buy items at the market or close the menu if there is nothing you want. If this character has a Two-Handed item in (RightHand), avoid equipping shields (LeftHand) as this will unequip the weapon.";
