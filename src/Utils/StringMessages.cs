...
namespace Pyran.NeuroFTK.Utils
{
    public static class StringMessages
    {
        ...
        public const string HexContext = "## hexes to choose, organized by realm names, displayed as: [(position x,z) (quest name) (has dead) (POI: state) (distance)]. Empty hexes only show position. ";
